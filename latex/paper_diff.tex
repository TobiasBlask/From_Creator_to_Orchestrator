...
%DIF DEL /tmp/paper_old.tex   Thu Mar  5 13:41:22 2026
%DIF ADD latex/paper.tex      Thu Mar  5 13:32:05 2026
...
Following \citeauthor{hevner2004design}'s~(\citeyear{hevner2004design}) guidelines, we evaluate in three steps. First, \textit{technical evaluation}: Section~\ref{sec:capabilities} documents what the pipeline achieved and where it failed, situated within the landscape of autonomous research \DIFdelbegin \DIFdel{systems }\DIFdelend \DIFaddbegin \DIFadd{agents }\DIFaddend (Table~\ref{tab:systems}). Second, \textit{reflexive evaluation}: our orchestrator interventions are analyzed as data (see ``Orchestrator trace'' below and Appendix~\ref{app:timeline}). Third, \textit{theoretical interpretation}: Section~\ref{sec:orchestrator} frames the production experience through distributed cognition, sociotechnical systems, and task-based automation theory.

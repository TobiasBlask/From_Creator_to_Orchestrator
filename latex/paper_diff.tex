...
\DIFdelbegin \textbf{\DIFdel{Transferability:}}%DIFAUXCMD
\DIFdel{Open-source codebase enables replication assessment. The production system is released as a reusable Claude Code plugin.}
